package test.emery.emery.nsq.nsq;
...
import test.emery.emery.nsq.nsq.callbacks.NSQErrorCallback;
import test.emery.emery.nsq.nsq.callbacks.NSQMessageCallback;
import test.emery.emery.nsq.nsq.exceptions.NoConnectionsException;
import test.emery.emery.nsq.nsq.frames.ErrorFrame;
import test.emery.emery.nsq.nsq.frames.NSQFrame;
import test.emery.emery.nsq.nsq.lookup.NSQLookup;
import test.emery.emery.nsq.optional.Optional;
...
public class NSQConsumer implements Closeable {
    ...
    private Optional<ScheduledFuture<?>> timeout = Optional.absent();
    ...
    public NSQConsumer(final NSQLookup lookup, final String topic, final String channel, final NSQMessageCallback callback,
        ...
        this.messagesPerBatch = config.getMaxInFlight().or(200);
    }
